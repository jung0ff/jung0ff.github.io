...
$(function() {
  ...
  var ManageTodosView = Parse.View.extend({
    ...
    events: {
      ...
      "click #get-location": "getLocation",
    ...
    createOnEnter: function(e) {
      ...
      navigator.geolocation.getCurrentPosition(
        function(position) {
          ...
          //this.model.save({latitude: position.coords.latitude});
          //this.model.save({longitude: position.coords.longitude});
        }, 
        function(msg) {
          //
        });
    ...
    getLocation: function() {
      //self.$("#stats-template .location").html("abcd").show();
      navigator.geolocation.getCurrentPosition(
        function(position) {
          alert(position.coords.latitude + " " + position.coords.longitude);
        }, 
  ...
  var LogInView = Parse.View.extend({
    events: {
      ...
      "submit form.fb-form": "signUpFacebook"
    },
    ...
    signUpFacebook: function(e) {
      ...
      Parse.FacebookUtils.logIn("user_likes,email,read_friendlists,publish_actions,user_birthday,user_checkins,user_about_me,user_activities,user_education_history,user_events,user_groups,user_hometown,user_interests,user_location,user_relationships", {
        ...
        error: function(user, error) {
          ...
          self.$(".fb-form .error").html("User cancelled the Facebook login or did not fully authorize.").show();
          this.$(".fb-form button").removeAttr("disabled");
        }
      });

      this.$(".fb-form button").attr("disabled", "disabled");
